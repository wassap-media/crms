<?php
// Debug endpoint for testing database connection and environment variables
header('Content-Type: text/plain');

echo "=== RISE CRM Debug Information ===\n\n";
...
echo "PHP Environment Arrays:\n";
echo "_ENV['RDS_ENDPOINT']: " . ($_ENV['RDS_ENDPOINT'] ?? 'NOT SET') . "\n";
echo "_SERVER['RDS_ENDPOINT']: " . ($_SERVER['RDS_ENDPOINT'] ?? 'NOT SET') . "\n\n";
...
if (getenv('RDS_ENDPOINT') && getenv('RDS_USERNAME') && getenv('RDS_PASSWORD')) {
    ...
    echo "✗ Missing required environment variables for database connection\n";
}
